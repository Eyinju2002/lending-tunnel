# Lending Tunnel: Decentralized Lending Affiliate Platform

A comprehensive decentralized lending affiliate system built on the Stacks blockchain using Clarity smart contracts.
...
1. **Loan Affiliate Contract (`loan-affiliate.clar`)**
   - Manages lending affiliate registration
   - Handles performance tier progression
   - Processes lending-based commissions
   - Tracks lending affiliate performance

2. **Loan Product Manager Contract (`loan-product-manager.clar`)**
   - Lending product listing and categorization
   - Lending promotional campaign management
   - Lending product bundle creation
   - Performance tracking for lending products

3. **Lending Leaderboard Contract (`lending-leaderboard.clar`)**
   - Maintains lending affiliate rankings
   - Manages performance-based rewards
   - Tracks lending performance metrics
   - Period-based lending competition management

4. **Loan Payout Manager Contract (`loan-payout-manager.clar`)**
   - Lending commission distribution
   - Flexible payment scheduling
   - Split commission management
   - Comprehensive lending payment history tracking
